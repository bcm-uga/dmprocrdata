...
dir.create("tmp", showWarnings=FALSE)
if (!file.exists('tmp/dmprocrdata_DE_subset.rds')){
...
probe_idx = apply_func(gene_list_candidates, 1, get_probe_names, meth_platform = meth_platform, pf_chr_colname = pf_chr_colname, pf_pos_colname = pf_pos_colname, up_str=updwn_str+slide, dwn_str=updwn_str+slide)
# methmybeachup::get_probe_names(gene, meth_platform=pf_meth)
